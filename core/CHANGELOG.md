...
abalias@Antons-MBP-2 release-pls-plz % git-cliff --config Cargo.toml                    
abalias@Antons-MBP-2 release-pls-plz % git-cliff --bump --config Cargo.toml
# Changelog

All notable changes to this project will be documented in this file.

## [core-v0.3.0] - 2024-12-12
...
- Test
- *(core-bin-1)* Important change in core bin 1 crate
- Update core bin 1

### 🐛 Bug Fixes

- Move cargo toml and lock into core dir
- Move cargo toml and lock into core dir
- Add cargo.lock file
- Changelog cleanup
- Try
- Try to fix config
- Test example with cargo toml in workspace
- Try to fix
- Test
- Try to fix config
...
- Try to fix config
- Test
- Update changelog from core bin 1
- Update changelog from core bin 1
- Update changelog from core bin 1
- Try to check config
- Try to check config
